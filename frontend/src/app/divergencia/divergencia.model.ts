...
export class Divergencia implements BaseEntity {
    ...
    // TODO extrair classe
    toJSONState(): Divergencia {
        // TODO clone() ?
        const copy: Divergencia = Object.assign({}, this);
...
class DivergenciaCopyFromJSON {

    private _json: any;

    private _analiseConverted: Divergencia;

    constructor(json: any) {
        this._json = json;
        this._analiseConverted = new Divergencia();
    }

    public copy(): Divergencia {
