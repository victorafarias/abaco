import {Component, Input, ViewChild, OnInit, Renderer2, ElementRef, Type } from '@angular/core'
import { fromEvent, interval, from } from 'rxjs'
import { Message } from 'primeng/api'
import { switchMap, takeUntil, pairwise, takeWhile } from 'rxjs/operators'
import {Componente, TipoTela} from './canvas-visaopf.model'
...
export class CanvasVisaopfComponent implements OnInit {
    ...
    typeSelect(){ 
        if(this.selectedType){
            this.tela.tipos = this.selectedType.label
            }
            this.selectedType = {label: this.tela.tipos}
    } 
