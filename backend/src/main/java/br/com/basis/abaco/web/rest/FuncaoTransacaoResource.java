...
public class FuncaoTransacaoResource {
    ...
    public ResponseEntity<FuncaoTransacao> updateFuncaoTransacao(
        ...
        log.info("DEBUG_UPDATE: Recebido update para FuncaoTransacao ID {}. Tipo: {}. DERs recebidos: {}. ALRs recebidos: {}", 
                 id, funcaoTransacaoDTO.getTipo(), 
                 funcaoTransacaoDTO.getDers() != null ? funcaoTransacaoDTO.getDers().size() : "null", 
                 funcaoTransacaoDTO.getAlrs() != null ? funcaoTransacaoDTO.getAlrs().size() : "null");
