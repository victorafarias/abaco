...
public interface SistemaRepository extends JpaRepository<Sistema, Long> {
    ...
    @Query("SELECT new br.com.basis.abaco.service.dto.SistemaDropdownDTO(s.id, s.sigla, s.nome, s.organizacao.id, s.organizacao.sigla) " +
        "FROM Sistema s ORDER BY s.sigla")
