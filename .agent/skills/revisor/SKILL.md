...
Balance thoroughness with pragmatism. Not every issue needs fixing—prioritize based on impact and effort.
...
- Assume malice—AI agents don't have intent
...
→ Ensure code directory structure is correct and language is specified

**"Can't determine requirements"**
→ Ask user for original prompt or intended behavior

**"Code uses unknown library"**
→ Likely hallucinated—flag as critical issue
